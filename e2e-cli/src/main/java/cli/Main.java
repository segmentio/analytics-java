...
public class Main {
  ...
  private static Map<String, Object> run(String[] args) throws Exception {
    ...
    Map<String, Object> config =
        (Map<String, Object>) input.getOrDefault("config", Collections.emptyMap());
  ...
  private static void sendEvent(Analytics analytics, Map<String, Object> event) {
    ...
    Map<String, Object> traits =
        (Map<String, Object>) event.getOrDefault("traits", Collections.emptyMap());
    Map<String, Object> properties =
        (Map<String, Object>) event.getOrDefault("properties", Collections.emptyMap());
    ...
    switch (type) {
      ...
      case "track":
        builder =
            TrackMessage.builder(eventName != null ? eventName : "Unknown Event")
      ...
      case "screen":
        builder =
            ScreenMessage.builder(name != null ? name : "Unknown Screen").properties(properties);
        break;
      case "alias":
