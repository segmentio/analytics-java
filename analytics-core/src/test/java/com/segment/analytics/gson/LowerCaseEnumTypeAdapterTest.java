...
public class LowerCaseEnumTypeAdapterTest {

  @Test public void throwsIOExceptionForNullValue() throws IOException {
    TypeAdapter<Message.Type> typeAdapter =
        new LowerCaseEnumTypeAdapterFactory.LowerCaseTypeAdapter<>(Message.Type.class);
  ...
  @Test public void factoryReturnsCorrectTypeAdapter() {
    ...
    assertThat(adapter).isInstanceOf(LowerCaseEnumTypeAdapterFactory.LowerCaseTypeAdapter.class);
  }
}
